...
const BookShelfAddButton: React.FC<{ onClick: () => void }> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="flex flex-col justify-center items-center w-[210px] h-[165px] rounded-[10px] bg-[#F9F9F9] gap-[5px] outline-[1px] outline-dashed outline-[#E0E0E0] outline-offset-[-1px]"
    >
      <Image
