      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-4 shadow-md">
          <div className="flex flex-col">
            <span className="text-sm text-gray-500">신규 신고</span>
            <div className="flex items-center justify-between mt-2">
              <span className="text-2xl font-bold">24</span>
              <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center">
                <FontAwesomeIcon icon={faFlag} className="text-orange-500" />
              </div>
            </div>
        ...
        <Card className="p-4 shadow-md">
          <div className="flex flex-col">
            <span className="text-sm text-gray-500">미처리 작품 승인</span>
            <div className="flex items-center justify-between mt-2">
            ...
            <span className="text-xs text-red-500 mt-2">
              <i className="fas fa-arrow-down"></i> 5% 감소
            </span>
          </div>
        </Card>
        ...
        <Card className="p-4 shadow-md">
          <div className="flex flex-col">
            <span className="text-sm text-gray-500">정지 회원</span>
            <div className="flex items-center justify-between mt-2">
        ...
        <Card className="p-4 shadow-md">
          <div className="flex flex-col">
            <span className="text-sm text-gray-500">총 웹툰</span>
            <div className="flex items-center justify-between mt-2">
