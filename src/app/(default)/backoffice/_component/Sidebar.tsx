    ...
    >
      ...
      <ScrollArea className="h-[calc(100vh-4rem)]">
        <nav className="p-4 space-y-1">
          ...
          <Button
            variant={activePage === 'reportManagement' ? 'secondary' : 'ghost'}
            className={`w-full justify-start text-left ${
          ...
          <Button
            variant={activePage === 'memberManagement' ? 'secondary' : 'ghost'}
            className={`w-full justify-start text-left ${
              activePage === 'memberManagement'
                ? 'bg-[#3A4D80]'
                : 'text-white hover:bg-[#3A4D80]'
            } !rounded-button whitespace-nowrap`}
            onClick={() => setActivePage('memberManagement')}
          >
            <FontAwesomeIcon icon={faUsers} className="mr-3 w-5 text-center" />
